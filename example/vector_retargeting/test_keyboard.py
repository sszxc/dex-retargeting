...
# 启动 MuJoCo viewer  
model = mujoco.MjModel.from_xml_path("/mnt/1tb1/xuechao/MuJoCo-Asset-Pipeline/asset/scene/teleop_scene_left_028_skillet_lid/teleop_scene_left_028_skillet_lid.xml")  
