...
def hmf_proto5_left_dummy_qpos_from_leap_joint_pos(joint_pos: np.ndarray) -> np.ndarray:
    ...
    # thumb
    a[10] = signed_angle_between_plane_and_vector(
        joint_pos[3] - joint_pos[2], x_dir, y_dir
    ) * -1.5
    a[11] = angle_between_vectors(joint_pos[3] - joint_pos[2], joint_pos[4] - joint_pos[3]) * 1.4 - 0.2
    a[12] = angle_between_vectors(joint_pos[3] - joint_pos[2], joint_pos[4] - joint_pos[3]) * 1.4 - 0.2
    a[13] = angle_between_vectors(joint_pos[3] - joint_pos[2], joint_pos[4] - joint_pos[3]) * 1.4 - 0.2
